...
public class TretGalInlineKeyboardLn {
    ...
    public static SendMessage tretGalInlineKeyboardLn(long chat_id) {
        ...
        inlineKeyboardButton1.setText("Лаврова");
        inlineKeyboardButton1.setCallbackData(LAVROVA.toString());
        InlineKeyboardButton inlineKeyboardButton2 = new InlineKeyboardButton();
        inlineKeyboardButton2.setText("Лагода-Шишкина");
        ...
        inlineKeyboardButton3.setText("Лагорио");
        inlineKeyboardButton3.setCallbackData(LAGORIO.toString());
        InlineKeyboardButton inlineKeyboardButton4 = new InlineKeyboardButton();
        inlineKeyboardButton4.setText("Ларионов");
        ...
        inlineKeyboardButton5.setText("Левитан");
        inlineKeyboardButton5.setCallbackData(LEVITAN.toString());
        InlineKeyboardButton inlineKeyboardButton6 = new InlineKeyboardButton();
        inlineKeyboardButton6.setText("Лентулов");
        ...
        inlineKeyboardButton7.setText("Лошаков");
        inlineKeyboardButton7.setCallbackData(LOSHAKOV.toString());
        InlineKeyboardButton inlineKeyboardButton8 = new InlineKeyboardButton();
        inlineKeyboardButton8.setText("Лубенников");
        ...
        inlineKeyboardButton9.setText("Маврина");
        ...
        inlineKeyboardButton10.setText("Маковский");
        ...
        inlineKeyboardButton11.setText("Малевич");
        inlineKeyboardButton11.setCallbackData(MALEVICH.toString());
        InlineKeyboardButton inlineKeyboardButton12 = new InlineKeyboardButton();
        inlineKeyboardButton12.setText("Малявин");
        ...
        inlineKeyboardButton13.setText("Машков");
        ...
        inlineKeyboardButton14.setText("Мильман");
        ...
        inlineKeyboardButton15.setText("Нестеров");
        ...
        inlineKeyboardButton16.setText("Нестерова");
        ...
        inlineKeyboardButton17.setText("Нивинский");
        ...
        inlineKeyboardButton18.setText("Никич");
        ...
        inlineKeyboardButton19.setText("Никонов");
