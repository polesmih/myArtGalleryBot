...
public class TretGalInlineKeyboardZk {
    ...
    public static SendMessage tretGalInlineKeyboardZk(long chat_id) {
        ...
        inlineKeyboardButton1.setText("Зайцев");
        inlineKeyboardButton1.setCallbackData(ZAICEV.toString());
        InlineKeyboardButton inlineKeyboardButton2 = new InlineKeyboardButton();
        inlineKeyboardButton2.setText("Захаров");
        ...
        inlineKeyboardButton3.setText("Зверьков");
        inlineKeyboardButton3.setCallbackData(ZVERKOV.toString());
        InlineKeyboardButton inlineKeyboardButton4 = new InlineKeyboardButton();
        inlineKeyboardButton4.setText("Иванов");
        inlineKeyboardButton4.setCallbackData(IVANOV.toString());
        rowInline2.add(inlineKeyboardButton3);
        rowInline2.add(inlineKeyboardButton4);

        List<InlineKeyboardButton> rowInline3 = new ArrayList<>();
        InlineKeyboardButton inlineKeyboardButton5 = new InlineKeyboardButton();
        inlineKeyboardButton5.setText("Истомин");
        inlineKeyboardButton5.setCallbackData(ISTOMIN.toString());
        InlineKeyboardButton inlineKeyboardButton6 = new InlineKeyboardButton();
        inlineKeyboardButton6.setText("Кандинский");
        ...
        inlineKeyboardButton7.setText("Келин");
        inlineKeyboardButton7.setCallbackData(KELIN.toString());
        InlineKeyboardButton inlineKeyboardButton8 = new InlineKeyboardButton();
        inlineKeyboardButton8.setText("Кипренский");
        ...
        inlineKeyboardButton9.setText("Киселев");
        ...
        inlineKeyboardButton10.setText("Комаров");
        ...
        inlineKeyboardButton11.setText("Коненков");
        inlineKeyboardButton11.setCallbackData(KONENKOV.toString());
        InlineKeyboardButton inlineKeyboardButton12 = new InlineKeyboardButton();
        inlineKeyboardButton12.setText("Коржев");
        ...
        inlineKeyboardButton13.setText("Корин");
        ...
        inlineKeyboardButton14.setText("Коровин");
        ...
        inlineKeyboardButton15.setText("Кравченко");
        ...
        inlineKeyboardButton16.setText("Крамской");
        ...
        inlineKeyboardButton17.setText("Куинджи");
        ...
        inlineKeyboardButton18.setText("Купреянов");
        ...
        inlineKeyboardButton19.setText("Кустодиев");
